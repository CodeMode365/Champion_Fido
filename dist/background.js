...
export class Background {
    constructor(game) {
        ...
        this.game = game;
        this.layer1image.src = "../assets/forest/layer-1.png";
        this.layer2image.src = "../assets/forest/layer-2.png";
        this.layer3image.src = "../assets/forest/layer-3.png";
        this.layer4image.src = "../assets/forest/layer-4.png";
        this.layer5image.src = "../assets/forest/layer-5.png";
